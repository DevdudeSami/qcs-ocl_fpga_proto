...
echo -e "================================="
rm -f host.exe error.log out.dat $1.aoco $1.aocx
echo -e "================================="
echo -e "Building Kernel"
echo -e "================================="
aoc -v --report -march=emulator --board p385_hpc_d5 -DTARGET=AOCL -DDEBUG ./kernels/$1.cl
echo -e "================================="
...
echo -e "Executing"
echo -e "================================="
env CL_CONTEXT_EMULATOR_DEVICE_ALTERA=1 ./host.exe $1.aocx
echo -e "================================="
echo -e "out.dat:"
cat out.dat