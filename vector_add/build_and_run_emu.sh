...
echo -e "================================="
aoc -v --report -march=emulator --board p385_hpc_d5 -DTARGET=AOCL -DDEBUG ./device/vector_add.cl
echo -e "================================="
...
echo -e "Executing"
echo -e "================================="
env CL_CONTEXT_EMULATOR_DEVICE_ALTERA=1 ./host.exe vector_add.aocx
echo -e "================================="
echo -e "out.dat:"
cat out.dat